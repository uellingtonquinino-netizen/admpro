...
import {
  Download, Upload, ShieldCheck, AlertTriangle, RotateCw, Building2,
} from 'lucide-react'

// ALTERADO: era a página própria /backup (item solto na barra
// lateral) — agora vive dentro de Configurações (SupervisorConfiguracoes.tsx),
// como mais uma categoria (Segurança, Carimbo de Assinatura, Backup),
// no mesmo padrão de cartão → tela própria com "Voltar". O conteúdo é
// o mesmo de sempre, só o wrapper (Card) mudou pra caber nesse novo lugar.
  ...
  return (
    <Card>
      {perfil === 'master' ? (
        ...
        <>
          <div className="flex items-center gap-1.5 text-sm text-gray-400 mb-1 mt-1">
