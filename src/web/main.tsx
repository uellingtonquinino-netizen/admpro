...
import { ArrowLeftRight, Bell, Boxes, Building2, CalendarDays, ChevronDown, LayoutDashboard, LogOut, MapPin, Menu, PackageMinus, PackagePlus, RefreshCw, Search, UsersRound, Wallet, X } from 'lucide-react'
...
function PortalWeb() {
  ...
  const [pagina, setPagina] = useState<'inicio' | 'financeiro' | 'rh' | 'almox' | 'estoque' | 'entradas' | 'saidas' | 'supervisor' | 'pessoal' | 'central'>('inicio')
  ...
  const navegar = (destino: 'inicio' | 'financeiro' | 'rh' | 'almox' | 'estoque' | 'entradas' | 'saidas' | 'supervisor' | 'pessoal' | 'central') => { setPagina(destino); setMenuAberto(false) }
